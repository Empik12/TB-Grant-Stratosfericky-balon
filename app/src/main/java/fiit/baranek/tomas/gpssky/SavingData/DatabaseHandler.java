...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_DATA_PATH = "data_path";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_PATH = "CREATE TABLE " + TABLE_DATA_PATH + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_LATITUDE + " TEXT,"
                + KEY_LONGITUDE + " TEXT," + KEY_ALTITUDE + " TEXT,"
                + KEY_BATTERY + " REAL,"
                + KEY_NETWORK_CONNECTION + " TEXT,"
                + KEY_TIME + " TEXT" + ")";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS" + TABLE_DATA_PATH);
        onCreate(db);
    }
    ...
    public void addDataPath(Data data){
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        values.put(KEY_NETWORK_CONNECTION, data.getNetworkConnection());
        values.put(KEY_TIME, data.getTime());
        db.insert(TABLE_DATA_PATH, null, values);
        db.close();
    }
    ...
    public List<Data> getAllDataPath(){
        List<Data> DataList = new ArrayList<Data>();

        String selectQuery = "SELECT * FROM " + TABLE_DATA_PATH;
